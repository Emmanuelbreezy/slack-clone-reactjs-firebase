                       ...
                       <div className="px-2">
                           <div className="px-28 align-middle text-center">
                               <fieldset className="mb-5">
                                    ...
                                    className="focus:ring focus:outline-none focus:border-transparent border border-gray-400 p-3 w-full
                                     rounded-md " onChange={handlerInput}  autoComplete="off"/>
                               </fieldset>
                               <fieldset className="mb-5 relative">
                                    <input placeholder="Password" type={visible === false ? "password" : "text"} className=" border-gray-400 focus:border-transparent input_pass focus:ring pr-12 focus:outline-none border p-3 w-full rounded-md " onChange={handlerInput} />
