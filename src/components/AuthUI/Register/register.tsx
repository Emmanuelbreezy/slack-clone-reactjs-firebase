                       ...
                       <div className="px-2">
                           <div className="px-10 md:px-28 lg:px-28 align-middle text-center">
                               ...
                               <fieldset className="mb-5 relative">
                                    <input name="password" placeholder="Password" type={visible === false ? "password" : "text"} 
                                    className=" border-gray-400 focus:border-transparent input_pass 
                                    focus:ring pr-12 focus:outline-none border p-3 w-full rounded-md " 
